...
shop.enter(async (ctx) => {
  ...
  await ctx.reply('Вошли в сцену shop, ставим новую локальную главную клавиатуру', backKeyboard);
  await ctx.reply('Тут ждем shop на входе с локальной клавиатурой', getShopInlineKeyboard(ctx));
});
